...
<?php echo card_open('Form','bg-green',true)?>	
	...
	<input hidden class='data-sending' id='id' value='<?php if(isset($id))echo $id?>'>
					...
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_channel_payment_nama_channel ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='nama_channel' name='nama_channel' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->nama_channel ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_channel_payment_desc ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='desc' name='desc' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->desc ?>' >
					</div>
					</div>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_channel_payment_image ?></label>
					...
					<div class='col-md-12 col-xl-12'>
					<div class='form-group'>
							<label class='form-label'><?php echo $title->t_channel_payment_category ?></label>
							<input type='text' class='form-control data-sending focus-color'  id='category' name='category' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if(isset($data)) echo $data->category ?>' >
					</div>
					</div>
