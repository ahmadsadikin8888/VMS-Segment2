	...
	<div class="card-body">
		<table width="100%">
			...
			<tr>
				...
				<td><input required type='text' class='form data-sending focus-color col-3' id='kode_voucher' name='kode_voucher' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if (isset($data)) echo $data->kode_voucher ?>'>
				</td>
			</tr>
			<tr>
				<td></td>
			...
			<tr>
				...
				<td> <input required type='text' class='form data-sending focus-color col-5' id='already_subscribe' name='already_subscribe' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if (isset($data)) echo $data->already_subscribe ?>'>&nbsp; Days
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>Special Day</td>
				<td>
					<input required type='text' class='form data-sending focus-color col-3' id='special_day' name='special_day' placeholder='<?php echo $title->general->desc_required ?>' value='<?php if (isset($data)) echo $data->kode_voucher ?>'>
			...
			<tr>
				<td>Regional</td>
				<td> <select required name='regional[]' id="select-regional" class="form custom-select" multiple="multiple">
			...
			<tr>
				<td>Witel</td>
				<td> <select required name='witel[]' id="select-witel" class="form custom-select" multiple="multiple">
			...
			<tr>
				...
				<td> <select required name='channel_payment[]' id="select-agent" class="form custom-select" multiple="multiple">
			...
			<tr>
				...
				<td> <select required name='jenis_pembayaran[]' id="select-agent" class="form custom-select" multiple="multiple">
			...
			<tr>
				<td>Addon</td>
				<td> <select required name='addon[]' id="select-agent" class="form custom-select" multiple="multiple">
			...
			<tr>
				<td>Jenis Voucher</td>
				<td>
					<select required name='jenis_cashback' id="select-agent" class="form custom-select">
